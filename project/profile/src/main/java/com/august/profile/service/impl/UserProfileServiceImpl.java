...
public class UserProfileServiceImpl implements UserProfileService {
    ...
    public void createProfileForUserRegistered(UserRegisteredEvent event) {
        if (userProfileRepository.existsByKeycloakId(event.getKeycloakId())) {
            return;
        }
    ...
    @Transactional
    @Override
    public void updateFollowerCount(String keycloakId, Long count) {
        userProfileRepository.updateFollowerCount(keycloakId, count);
    }

    @Transactional
    @Override
    public void updateFollowingCount(String keycloakId, Long count) {
        userProfileRepository.updateFollowingCount(keycloakId, count);
    }
